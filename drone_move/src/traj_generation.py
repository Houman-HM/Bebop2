...
def traj_quadrotor_comp():
	...
	G = vstack(( A_x[num_samples/3-1], A_x[2*num_samples/3-1], A_x[-1], A_xdot[-1], A_xddot[-1]  ))
	H = vstack(( P_x[num_samples/3-1], P_x[2*num_samples/3-1], P_x[-1], P_xdot[-1], P_xddot[-1]  ))
